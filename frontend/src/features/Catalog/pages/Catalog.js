		...
		},
		{
			...
			manager: {
				...
				columns: [
					...
					{title: 'Kênh', dataIndex: 'channel', key: 'channel', width: 100, render: (v) => channelMap[v] || v},
						{title: 'Sau (ngày)', dataIndex: 'offset_days', key: 'offset_days', width: 95, align: 'center'},
						{title: 'Tự áp', dataIndex: 'auto_apply', key: 'auto_apply', width: 80, align: 'center', render: (v) => (v ? '✓' : '')},
				...
				fields: [
					...
					{name: 'content', label: 'Nội dung (dùng {{ten_khach}})', type: 'textarea', rows: 4},
						{name: 'auto_apply', label: 'Chuỗi chăm sóc tự động', type: 'switch', default: false, checkboxLabel: 'Tự áp cho khách mới (thuộc chuỗi mặc định)'},
						{name: 'offset_days', label: 'Làm sau (ngày)', type: 'number', placeholder: '0 = ngay hôm nay, 3 = sau 3 ngày'},
						{name: 'sort_order', label: 'Thứ tự bước', type: 'number', placeholder: '0, 1, 2...'},
					{name: 'is_active', label: 'Trạng thái', type: 'switch', default: true},
				],
