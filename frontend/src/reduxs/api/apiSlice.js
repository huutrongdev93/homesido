...
export const apiSlice = createApi({
	...
	tagTypes: ['Notification', 'Customer', 'Property', 'Care', 'Interaction', 'Demand', 'LeadSource', 'Project', 'PropertyOwner', 'CareTemplate', 'PropertyMedia', 'Storage', 'Match', 'Appointment', 'Deal'],
	endpoints: () => ({}),
});
